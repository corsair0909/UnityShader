...
//        _WaveC("WaveC",vector) = (1,1.3,0.25,18)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 FlowUVW(float2 uv,float2 offset,float tiling,float time,bool flow)
            {
                //jump部分没看懂
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 uv1 = FlowUVW(i.uv,var_FlowMap,_Tiling,time,true);
                float3 uv2 = FlowUVW(i.uv,var_FlowMap,_Tiling,time,false);
